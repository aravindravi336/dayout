...
<NavBar />
<h1 class="display-2">Student Packages</h1>
                    ...
                    <div className="row gy-3">
                        <div className="col col-12 col-sm-6 col-md-4 col-lg-3 col-xl-3 col-xxl-3">
                            ...
                            <div class="card shadow p-3 mb-5 bg-white rounded" >
                                ...
                                <div class="card-body">
                                    <h5 class="card-title">Package Sample</h5>
                                    <p class="card-text">Explore the beautiful Package </p>
                                    <Link to="/studentbook" class="btn btn-primary">Book Now</Link>
                                </div>
                            </div>
